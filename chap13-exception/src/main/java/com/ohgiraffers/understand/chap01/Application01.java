...
public class Application01 {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            String name;
            int accountNumber;
            BankAccount01 ba = new BankAccount01();
            ...
            switch (no){
                ...
                case 1 :
                    ...
                    ba.account(new BankAccount01(accountNumber, name, 0));
                ...
                case 2 :
                    ...
                    int depositMoney = scr.nextInt();

                    ba.deposit(new BankAccount01(accountNumber, "", 0), depositMoney);
