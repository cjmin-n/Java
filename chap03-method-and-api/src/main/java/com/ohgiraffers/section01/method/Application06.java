...
public class Application06 {
    public static void main(String[] args){
        ...
        * void 는 아무 반환값을 가지지 않겠다는 리턴값에 사용할 수 있는 키워드이다.
        * 반환값이 없는 경우 return 을 생략해도 컴파일러가 자동으로 추가하지만, 반환값이 있는 경우 return 구문을 반드시 명시적으로 작성 해야한다.
        * 또한 메소드 선언부에 선언한 리턴타입과 반환값의 자료형은 반드시 일치해야 한다.
        * */

        Application06 app06 = new Application06();

        String returnValue = app06.test();
        System.out.println(returnValue); // Hello World!
        System.out.println(app06.test()); // Hello World!
