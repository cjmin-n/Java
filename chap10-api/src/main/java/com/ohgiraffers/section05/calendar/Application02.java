...
public class Application02 {
    public static void main(String[] args) {
        ...
        * 2. 후손 클래스인 GregorianCalendar() 클래스를 이용해서
        * 인스턴스를 생성하는 방법
        *
        * */
        ...
        // GregorianCalender(국제표준시) 의 생성자로 제공한다.
        ...
        Calendar today = new GregorianCalendar(year, month, dayOfMonth, hour, minute, second);
        ...
        int todayYear = today.get(1);  // 인덱스
        int todayMonth = today.get(2);
        int todayOfMonth = today.get(5);

        System.out.println(todayYear);
        System.out.println(todayMonth);
        System.out.println(todayOfMonth);
