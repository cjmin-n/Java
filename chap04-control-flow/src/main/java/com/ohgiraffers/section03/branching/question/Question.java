...
public class Question {
    public static void main(String[] args) {
        ...
        * 잘못된 음료수가 선택되면 다시 받아야 한다. -> 스캐너 활용
        * 
        * 음료수를 선택하면 -> nextLine(); 계산 여부를 물어본 후 -> sout
        * 계산을 고르면 -> nextLine(); 총 금액과 고른 음료수를 출력 해 주어야 한다. -> sout
        * 
        * 예시 ) 
        * 음료를 선택 해주세요 : ->sout
        * -> nextLine();
        ...
        * ========================= 조 건 문 =========================================
        * 네 -> break; 반복문 나가기               |   아니오
        * ----------------------> 반복문 //      |   음료를 더 선택 해주세요. -> sout
        * 총 상품은 사이다                         |   -> nextLine();
        * 총 금액은 500원 입니다.                  |   콜라
        *                                       |   콜라를 선택 하셨습니다. -> sout
        *  -> 반복문 밖의 sout                    |   continue; 다시 반복문 실행
        *                                       <---------------------- //반복문
        *                                       계산 하시겠습니까?  ->sout
        *                                       네 -> nextLine();
        *                                       ----------------------> 반복문 //
    ...
    * 무한루프 반복문 만들기
    * 스캐너를 이용해 원하는 음료를 입력 받기 -- 없을 시 continue 를 이용하면 좋아요
